from apps.views.cart import CartListView, CartDetailView, CartDeleteView
from apps.views.category import CategoryCreateView, CategoryUpdateView, CategoryDeleteView, CategoryListView, \
    CategoryDetailView
