    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='colors', to='apps.product')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
                ...
                ('product_color', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.productcolor')),
            ],
        ),
        migrations.CreateModel(
            name='CartItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_color', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='apps.productcolor')),
            ],
        ),
        migrations.AddField(
            model_name='order',
        ...
        migrations.AddField(
            model_name='cart',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='cart', to='apps.user'),
        ),
    ]
